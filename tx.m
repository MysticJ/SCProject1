...
% txsyms_us = upsampling(txsyms, os_factor)
txsyms_us = reshape(repmat(txsyms, 1, os_factor).', [], 1); % upsampling
...
% figure(1); plot(txsignal(npreamble*os_factor+1:(npreamble+5.5)*os_factor), 'Linewidth', 1); ylabel('txsignal')
