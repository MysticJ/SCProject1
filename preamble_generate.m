...
% A linear feedback shift register (LFSR) which outputs 
% a PN sequence of length output_length.
% The current LFSR has a period length of 255, but the 
% polynomial can easily be changed for a longer one.
